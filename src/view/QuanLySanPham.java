...
public class QuanLySanPham extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(QuanLySanPham.class.getName());
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this,
                ...
                "Inane warning",
                JOptionPane.ERROR_MESSAGE);
            System.getLogger(QuanLySanPham.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
        } catch(Exception ex) {
            // Bắt lỗi chung
